...
@WebServlet("/cadastrarMedicoServlet")
...
private static final long serialVersionUID = 1L;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("cadastrar".equals(action)) {
            ...
            func.setValidador(Integer.parseInt(request.getParameter("crm")));
            ...
            if (func.getValidador() < 0 || validador.length() < 6
                ...
                request.setAttribute("erroCadastro", "CRM ou CPF inválido!");
            } else {
                try {
            ...
            if (func.getValidador() < 0 || String.valueOf(func.getValidador()).length() < 6) {
                request.setAttribute("erroCadastro", "CRM inválido!");
                request.getRequestDispatcher("cadastrarMedico.jsp").forward(request, response);
                return;
            }
